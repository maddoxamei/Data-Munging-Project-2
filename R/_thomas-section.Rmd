...
```{r}
#Suicide rate by gini, average and yearly, worldwide.
...
subregions.mat
ncol(subregions.mat)
for(j in 1:23){ #Ideally should be ncol(continents.mat)-1 instead of 7.
...
subregions.df<-data.frame(subregions.mat)
```
