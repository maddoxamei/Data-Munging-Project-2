...
> All plots are interactive. The following scatter plot produced in Plotly also enables you to select and deselect components within the plot. Double-clicking on a color in the legend will display only the points of that color, while single-clicking on a color in the legend will add or remove the corresponding points from the plot. 
...
The scatter plot confirms the positive correlation that we observed between birth rate and income inequality in the correlation matrix. However, it also provides greater depth to our understanding. 
